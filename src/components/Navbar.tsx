...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Fullscreen premium menu overlay — split screen with mesh gradient + glass cards */}
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            className="fixed inset-0 z-[100] bg-[#0a1d3f] text-white flex flex-col overflow-hidden"
          >
            {/* Mesh gradient backdrop (animated, low opacity) */}
            <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.35 }}>
              {/* Inline mesh-style gradient — fallback via CSS since WebGL canvas is heavy here */}
              <div
            ...
            {/* Animated amber orb that drifts subtly */}
            <motion.div
            ...
            <motion.div
              ...
              className="relative z-10 px-5 md:px-10 py-5 flex items-center justify-between"
            >
            ...
            <div className="relative z-10 flex-1 flex flex-col lg:flex-row min-h-0">
              {/* Left: nav links with staggered reveal */}
              <nav className="flex-1 flex flex-col justify-center px-5 md:px-10 lg:px-14 py-6 lg:py-0 overflow-y-auto celsius-scroll">
                <motion.span
                  ...
                  className="celsius-chip-light mb-6 w-fit"
                >
