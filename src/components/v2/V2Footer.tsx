...
export default function V2Footer() {
  return (
    <footer className="relative w-full bg-black text-white v2-font-sans py-12 sm:py-16 px-5 sm:px-6 md:px-10 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          {/* Brand */}
          <div className="md:col-span-5">
            <div className="v2-font-serif italic text-4xl font-medium mb-3">Celsius</div>
            <p className="text-sm text-white/50 max-w-xs leading-relaxed">
              Excellence in cooling since 2019. Domestic, commercial &amp; industrial HVAC across Sri Lanka.
            </p>
          </div>

          {/* Nav */}
          <div className="md:col-span-3">
            <div className="text-[11px] uppercase tracking-[0.3em] text-[var(--accent-amber)] mb-4">Explore</div>
          ...
          <div className="md:col-span-4">
            <div className="text-[11px] uppercase tracking-[0.3em] text-[var(--accent-amber)] mb-4">Contact</div>
            <ul className="flex flex-col gap-2.5 text-sm">
              <li><a href="tel:+94777136560" className="text-white/65 hover:text-white transition-colors">+94 777 136 560</a></li>
