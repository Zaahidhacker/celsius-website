...
export default function V9Footer() {
  return (
    <footer className="v9-footer">
      <div className="v9-container">
        <div className="v9-footer-grid">
          <div className="v9-footer-brand">
            <img src="/celsius-logo-white.png" alt="Celsius" />
            <p className="v9-footer-tagline">
          ...
          {COLS.map((c) => (
            <div key={c.title}>
              <h4 className="v9-footer-col-title">{c.title}</h4>
              <ul className="v9-footer-list">
                {c.links.map((l) => (
                  <li key={l.label}>
